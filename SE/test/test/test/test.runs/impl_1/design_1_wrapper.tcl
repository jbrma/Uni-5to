...
namespace eval ::optrace {
  variable script "C:/hlocal/test/test/test.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/hlocal/test/test/test.cache/wt [current_project]
